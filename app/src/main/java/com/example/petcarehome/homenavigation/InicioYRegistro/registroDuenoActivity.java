                ...
                mAuth.createUserWithEmailAndPassword(correo, contrasena).addOnCompleteListener(registroDuenoActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            ...
                            ayudaRegistroDueno ayudaRegistroDueno = new ayudaRegistroDueno(nombre, apellido, calle, noext, noint, alcaldia, telefono);
                            ...
                            currentUserDB.child(telefono).setValue(ayudaRegistroDueno);
