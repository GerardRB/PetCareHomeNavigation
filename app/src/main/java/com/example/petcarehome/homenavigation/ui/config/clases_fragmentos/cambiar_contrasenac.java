...
public class cambiar_contrasenac extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.cambiar_contrasenac_fragment, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        contra1 = view.findViewById(R.id.contrasena_modifc);
        contra2 = view.findViewById(R.id.contrasena_modif2c);
        actualizarContra = view.findViewById(R.id.actualizarContrac);
                            ...
                            user.updatePassword(contraseña).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (!task.isSuccessful()){
                                        ...
                                        cuidadorRef.child("contraseña").setValue(contraseña);
