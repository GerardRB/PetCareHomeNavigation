 ...
 */
public class DifusionTabFragment extends Fragment {
    ...
    public static DifusionTabFragment newInstance(int index) {
        DifusionTabFragment fragment = new DifusionTabFragment();
    ...
    public View onCreateView(
        ...
        AdapterReportes adapter = new AdapterReportes(listReportes);
    ...
    private void llenarReportes() {
        for(int i = 0; i<=15; i++){
            listReportes.add(new ReporteVo("Nombre", "Fecha", "Descripcion", ic_perro));
        }
    }
}